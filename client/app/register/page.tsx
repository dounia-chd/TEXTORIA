...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success('Registration successful! Welcome to TEXTORIA!')
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6 py-12">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-black mb-2">Join TEXTORIA</h1>
            <p className="text-gray-600">Create your account and start generating amazing content</p>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-4">
                ...
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2 flex-shrink-0" />
                    Access to GPT-3.5 and DALL-E 2
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2 flex-shrink-0" />
